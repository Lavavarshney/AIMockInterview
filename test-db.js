...
const pool = new Pool({
  connectionString: 'postgresql://neondb_owner:npg_DOwK5xLMmXG7@ep-long-tree-aqkkqbpy-pooler.c-8.us-east-1.aws.neon.tech/neondb?sslmode=require&channel_binding=require',
  max: 10
});
